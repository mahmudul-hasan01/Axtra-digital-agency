...
const WhyChooseUs = () => {
  ...
  return (
    <div className="overflow-hidden">
      <div ref={triggerRef}>
        <div ref={sectionRef} className="flex flex-nowrap h-screen">
          <div
            className={`panel w-screen  h-screen flex items-center justify-center  flex-shrink-0 `}
          >
            <h1 className="text-6xl md:text-9xl font-semibold uppercase text-center">
              Why <br /> Choose Us{" "}
            </h1>
          </div>
          <div
            className={`panel w-screen h-screen flex-shrink-0 px-4 sm:px-6 md:px-8 lg:px-16 `}
          >
                ...
                <div className="flex items-center gap-4 sm:gap-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm sm:text-base">
                      Your marketing strategy optimizing performances doesn't
          ...
          {/* # */}
          <div
            className={`panel w-screen h-screen flex flex-shrink-0 px-5 lg:px-16`}
          >
            {/* Left Section */}
