    ...
    <div className="bg-[#171717] text-white relative overflow-hidden">
      ...
      <div className="max-w-screen-xl mx-auto px-5 relative z-1">
        <div className="flex flex-col lg:flex-row justify-between items-center ">
          <div
            className={`w-full lg:w-7/12 xl:w-8/12 xl:border-r overflow-hidden`}
          >
            <div
              ref={imageRef}
              className="transform flex justify-center lg:justify-start"
            >
          ...
          <div className="hidden lg:block">
            <div className="absolute top-32 left-[600px] xl:left-1/2 transform">
              <div className="bg-[#171717] px-5 py-16">
                ...
                <h1
                  ref={hiddenSubHeadingRef}
                  className="font-semibold text-4xl xl:text-5xl uppercase xl:w-[500px]"
                >
