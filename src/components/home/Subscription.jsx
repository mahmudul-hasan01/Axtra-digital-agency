...
const Subscription = () => {
    ...
    return (
        <div
            ...
            className={` px-5 md:p-8 lg:p-12 overflow-x-hidden `}
        >
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="my-16">
                            ...
                            >
                                <span
                                    className={`absolute inset-0  rounded-full transition-all duration-300 ease-in-out transform scale-0 group-hover:scale-150 `}
                                    style={{
                                        zIndex: -1,
                                    }}
                                ></span>
