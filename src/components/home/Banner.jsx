      ...
      <div className="max-w-screen-xl mx-auto py-20 md:pb-96 relative">
        ...
        <div className="px-5">
          <div className="flex gap-10 items-center">
            ...
            <div className={`w-24 h-[1px] `}></div>
          </div>
          <div className="flex justify-between items-center">
            <h1
              ref={textRef}
              className={`text-8xl md:text-[160px] lg:text-[180px] 2xl:text-[280px] leading-none uppercase font-semibold`}
            >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 lg:-mt-10 px-5">
          ...
          <h1
            ref={textRef2}
            className={`order-1 sm:order-2 text-end sm:text-center md:text-start text-8xl z-1 w-full md:w-8/12 z-40 md:text-[160px] lg:text-[180px] 2xl:text-[280px] leading-none uppercase font-semibold`}
          >
