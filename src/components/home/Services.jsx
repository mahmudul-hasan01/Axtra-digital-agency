...
const Services = () => {
  ...
  const data = [
    {
      ...
      img: SearchEngine,
      bulletPoints: ["Logo Design", "Advertisement", "Promotion"],
    },
    {
      id: 2,
  ...
  const ServiceCard = ({ service, index }) => {
    ...
    return (
      <div
        ref={cardRef}
        className={`relative md:border-b md:last:border-b-0  py-20 px-5`}
        onMouseEnter={() => {
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start gap-5 md:gap-16 relative z-20">
          <div className="w-full md:w-1/3">
            <h2
              className={`text-3xl lg:text-5xl font-bold  transition-all duration-300 group-hover:text-gray-500`}
            >
              {service.title}
            </h2>
          </div>
          ...
          <div className="w-full md:w-1/3 flex justify-start md:justify-end">
            ...
            >
              <span
                className={`absolute inset-0 rounded-full transition-all duration-300 ease-in-out transform scale-0 group-hover/button:scale-150 `}
                style={{ zIndex: 1 }}
              ></span>
        ...
        <div className="md:block hidden ">
          <div
            className={`fixed pointer-events-none z-10 -mt-24 -ml-24 rounded-lg overflow-hidden transition-opacity duration-300 ${
              hoveredService === service.id && isMouseInBounds
                ? "opacity-100"
                : "opacity-0"
            }`}
            style={{
      ...
      <div className="max-w-screen-xl mx-auto px-5 relative ">
        <div className="hidden md:block">
          <div className="">
            <div className="absolute top-32 left-[300px] lg:left-[380px] xl:left-[350px] transform">
              ...
              >
                <h3
                  className={`text-lg uppercase font-semibold  mb-2 tracking-wide`}
                >
                  Services
                </h3>
          ...
          <div className="flex justify-center items-center ">
            ...
            <div
              className={`w-7/12 border-s`}
            >
              <div ref={subHeadingRef} className="pt-80 mb-24 px-5">
                <p
                  className={`pt-10 text-lg w-3/4`}
                >
        ...
        <div className="block md:hidden">
          <div className="px-5 py-5">
            <h3
              className={`text-md uppercase font-semibold  mb-2 tracking-wide`}
            >
              Services
            </h3>
